...
setup_factory.add('Possível Setup 9.3 de Compra',
                ...
                and (stock_2_price_high > stock_3_price_high
                    or stock_3_price_high > stock_3_price_close)
                and (stock_3_price_high > stock_4_price_high
                    or stock_4_price_high > stock_4_price_close)
                and (stock_4_price_high > stock_5_price_high
                    or stock_4_price_high > stock_5_price_close)
...
setup_factory.add('Possível Setup 9.2 de Compra',
                ...
                and (stock_1_price_high > stock_2_price_high
                    or stock_1_price_high > stock_2_price_close)
                and (stock_2_price_high > stock_3_price_high
                    or stock_3_price_high > stock_3_price_close)
                and (stock_3_price_high > stock_4_price_high
                    or stock_4_price_high > stock_4_price_close)
...
setup_factory.add('Possível Setup 9.1 de Venda',
                ...
                and stock_2_price_close > stock_2_ema_9
                and stock_3_price_close > stock_3_ema_9
                and stock_4_price_close > stock_4_ema_9
                and stock_1_ema_9 > stock_2_ema_9
                and stock_2_ema_9 > stock_3_ema_9
                and stock_3_ema_9 > stock_4_ema_9
...
setup_factory.add('Possível Setup 9.2 de Venda',
                ...
                and stock_3_ema_9 < stock_4_ema_9
                and stock_4_ema_9 < stock_5_ema_9
                and stock_5_ema_9 < stock_6_ema_9
                """)
